...
- OPTIONS /:version/ordernotifications/ → None
- POST /:version/orders/:id/ordernotifications/ → Create a order notification of the given type. This will trigger an e-mail of the given type.
"""
...
class Ordernotifications(CCVApiEndpoints):
    """
